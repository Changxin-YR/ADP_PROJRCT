...
import type { SalesDelivery, SalesOrder, SalesPage, SalesReceivable, SalesReceipt } from '../../common/api/sales.models'

const api = createApiClient()
const base = '/api/v1/sales'
export interface SalesListQuery { page?: number; page_size?: number; status?: string; search?: string }
