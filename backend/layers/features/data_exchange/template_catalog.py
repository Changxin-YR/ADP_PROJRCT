...
TEMPLATES = (
    ...
    _template("receipts", "入库记录", "物料与仓储", CODE, NAME, WAREHOUSE_ID, Field("material_id", "物料ID", True, "integer"), QTY, DATE),
    _template("issues", "出库记录", "物料与仓储", CODE, NAME, WAREHOUSE_ID, Field("material_id", "物料ID", True, "integer"), QTY, DATE),
    _template("warehouse-transfers", "调拨记录", "物料与仓储", CODE, NAME, WAREHOUSE_ID, Field("target_warehouse_id", "目标仓库ID", False, "integer", "2"), Field("material_id", "物料ID", True, "integer"), QTY, DATE),
    _template("returns", "退库记录", "物料与仓储", CODE, NAME, WAREHOUSE_ID, Field("material_id", "物料ID", True, "integer"), QTY, DATE),
